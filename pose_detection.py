...
def video_stream(app, pose_name):
  ...
  while True:
      ...
      # Perform pose detection here using MediaPipe
        ...
        try:
            ...
            try: 
              global correctness_checklist
              correctness_checklist = pose_correction.generate_remarks(landmarks, pose_name)
            except:
              print('########### Error in genrating correctness checklist in pose_detection.py')
            try:
