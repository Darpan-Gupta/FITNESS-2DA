...
1-> Helps user to correct its posture while performing yoga pose. 
2-> Provide live feedback in the form audio and text. 
3-> Integrated a timer functionality to track the duration for which the user maintained the correct posture.
